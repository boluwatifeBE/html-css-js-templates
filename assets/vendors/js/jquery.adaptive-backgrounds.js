...
(function ($) {
	...
	var DATA_PARENT_SIB = 'data-ab-parent-sib';
      ...
      */
        ...
        */
				...
				$this.on(EVENT_CF, function (ev, data) {
					...
					// Try to find the parent-siblings.
					var $parentSiblings;
					if (
						opts.parentSiblings &&
						$this.parents(opts.parent).siblings(opts.parentSiblings).length
					) {
						$parentSiblings = $this
							.parents(opts.parent)
							.siblings(opts.parentSiblings);
					} else if (
						$this.attr(DATA_PARENT_SIB) &&
						$this
							.parents($this.attr(DATA_PARENT))
							.siblings($this.attr(DATA_PARENT_SIB)).length
					) {
						$parentSiblings = $this
							.parents($this.attr(DATA_PARENT))
							.siblings($this.attr(DATA_PARENT_SIB));
					} else if (useCSSBackground()) {
						$parentSiblings = $this;
					} else if (opts.parentSiblings) {
						$parentSiblings = $this
							.parents(opts.parent)
							.siblings(opts.parentSiblings);
					} else {
